    ...
    <>
      ...
      <main>
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-8 px-3 py-12 sm:px-6 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }}>
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-accent">Product Features</p>
              <h1 className="mt-4 text-3xl font-semibold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">A complete media console for your Telegram cloud.</h1>
              ...
              <Link to="/signup"><Button className="mt-8 w-full sm:w-auto">Create workspace <ArrowRight size={16} /></Button></Link>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <Card key={title as string} className="p-4 sm:p-5 sm:odd:translate-y-4">
        ...
        <section className="mx-auto grid max-w-7xl gap-10 px-3 py-12 sm:px-6 sm:py-16 lg:px-8">
          {[
            ...
            <div key={title as string} className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="rounded-xl border border-border bg-panel p-3">
                <div className="grid h-44 place-items-center rounded-lg bg-[#090c13] text-sm text-muted sm:h-64">
