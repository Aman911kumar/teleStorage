...
export function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[272px_1fr]">
      ...
      <aside className={cn("fixed inset-y-0 left-0 z-50 w-72 border-r border-border/80 bg-[#080b11]/95 p-3 shadow-2xl backdrop-blur-xl transition duration-300 lg:sticky lg:top-0 lg:block lg:w-auto lg:shadow-none", sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0")}>
